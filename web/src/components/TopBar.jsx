...
export default function TopBar() {
  ...
  return (
    <div className="topbar mobile-only">
      {/* Left slot (profile avatar chip) */}
      <button className="tb-slot tb-left" aria-label="Open profiles" onClick={() => navigate("/profiles")}>
        {active?.avatar
      ...
      {/* Right slot (notifications) */}
      <NavLink to="/notifications" className="tb-slot tb-right" aria-label="Notifications">
        <Bell size={20}/>
      </NavLink>
    </div>
  );
